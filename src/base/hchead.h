...
#define  FPS_PMA1_MAX                   (FPS_4000_PMA1+FPS_4000_RANGE)
#define  FPS_PMA1_MIN                   (FPS_4000_PMA1-FPS_4000_RANGE)

#define  FPS_PXA2_MAX                   (FPS_PXA2_NOR+FPS_2000_RANGE)
#define  FPS_PXA2_MIN                   (FPS_PXA2_NOR-FPS_2000_RANGE)
...
#define LDS_INFO_START       0xAA
	...
	typedef struct tsSubsection
	{
		float n1_org;              //ԭʼn1ֵ
		float n2_org;              //ԭʼ0n2ֵ
		UINT8 ulower_0 = 0;         //�ֶα궨��0����ֵ
		UINT8 uupper_0 = 1;         //�ֶα궨��0����ֵ
		UINT8 ulower_1 = 1;         //�ֶα궨��1����ֵ
		UINT8 uupper_1 = 2;         //�ֶα궨��1����ֵ
		UINT8 ulower_2 = 2;         //�ֶα궨��2����ֵ
		UINT8 uupper_2 = 4;         //�ֶα궨��2����ֵ
		UINT8 ulower_3 = 4;         //�ֶα궨��3����ֵ
		UINT8 uupper_3 = 6;         //�ֶα궨��3����ֵ
		UINT8 ulower_4 = 6;         //�ֶα궨��4����ֵ
		UINT8 uupper_4 = 8;         //�ֶα궨��4����ֵ
		float n1_subsection_0;     //�ֶα궨��0��n1ֵ  
		float n2_subsection_0;     //�ֶα궨��0��n2ֵ
		float n1_subsection_1;     //�ֶα궨��1��n1ֵ  
		float n2_subsection_1;     //�ֶα궨��1��n2ֵ
		float n1_subsection_2;     //�ֶα궨��2��n1ֵ
		float n2_subsection_2;     //�ֶα궨��2��n2ֵ
		float n1_subsection_3;     //�ֶα궨��3��n1ֵ
		float n2_subsection_3;     //�ֶα궨��3��n2ֵ
		float n1_subsection_4;     //�ֶα궨��4��n1ֵ
		float n2_subsection_4;     //�ֶα궨��4��n2ֵ
		void reset()
		{
			n1_org = 0;
			n2_org = 0;
	...
	typedef struct tsPackUID
	{
		...
		UINT16       u16AngleOffset;  //2 �ǶȲ�������λ0.01�ȣ�
		UINT8        u8LDDirection;
		UINT8        u8CorrectionEnble;  //
		UINT8        uReserved2[4];  //5 Ԥ��
		UINT8        uSN[20];      //
	}tsPackUID;
	...
	typedef struct tsPointCloudHeadPMA1
	{
		UINT16       u16Head;
		UCHAR        u8Info;
		UCHAR        u8Num;
	...
	typedef struct tsPointCloudTailPMA1TS
	{
		UINT16       u16LastAng;
		UINT64       u64TS;
		UINT16       u16CheckSum;
	}tsPointCloudTailPMA1TS;

	typedef struct tsPointCloudTailPMA1
	{
		UINT16       u16LastAng;
		UINT16       u16CheckSum;
	}tsPointCloudTailPMA1;
